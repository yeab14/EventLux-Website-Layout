import { FaRegCalendar, FaMapMarkerAlt, FaConciergeBell, FaMusic } from 'react-icons/fa';
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg">
            ...
            <p>Custom menus and luxurious decorations tailored to your taste.</p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <FaMusic className="text-4xl text-green-600 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2">Entertainment & Music</h3>
            <p>Live bands, DJs, and entertainment to keep your guests engaged.</p>
          </div>
        </div>
      </div>
    </section>
